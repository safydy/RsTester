...
class GOOGLE_API_3
{
        ...
        window.onload = function(){
		  ...
		  // Creating an InfoWindow object
			if($this->marker[$i]['info']!='')
			{
				...
				$this->code.=" google.maps.event.addListener(marker".$i.", 'dragend', function() { $.fctSetPosition(marker".$i.".getTitle(),marker".$i.".getPosition().lat(),marker".$i.".getPosition().lng()); });";
			}
	}
	...
	public function addMarker($lat='14.0730',$lng='56.0848',$click='false',$title='My WorkPlace',$info='Hello World',$icon='',$draggable='false',$map='map')
	{
